...
export const SignInPage: React.FC = () => {
  return (
    <div className="min-h-screen bg-neutral-light flex items-center justify-center py-20 px-4 relative overflow-hidden mesh-gradient">
      ...
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-primary/5 rounded-full blur-[120px] -mr-64 -mt-64 animate-float" />
      <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-secondary/5 rounded-full blur-[100px] -ml-48 -mb-48 animate-pulse" />

      <motion.div 
        initial={{ opacity: 0, y: 30 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.6 }}
        className="w-full max-w-4xl bg-white rounded-[3rem] shadow-[0_40px_100px_-20px_rgba(0,0,0,0.15)] overflow-hidden flex flex-col md:flex-row border border-secondary/5"
      >
        ...
        <div className="flex-1 p-8 md:p-20 relative bg-white">
            <SignInPageContent initialMode="signin" />
        </div>
      </motion.div>
    </div>
  );
