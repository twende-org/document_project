  ...
  return (
    <div className="bg-secondary p-8 rounded-card shadow-premium border-l-4 border-primary relative overflow-hidden group">
      <div className="flex justify-between items-center relative z-10 text-left">
        <div>
          <p className="text-[10px] font-black uppercase tracking-[0.4em] text-white/40 mb-2">{t('agent.service_balance')}</p>
          <div className="flex items-baseline gap-2">
            <span className="text-5xl font-black text-white tracking-tighter tabular-nums">{credits}</span>
            <span className="text-xs font-bold text-primary uppercase">{t('pricing.credits')}</span>
          </div>
        </div>
