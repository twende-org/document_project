      ...
      preview={
        <div className="bg-white p-12 shadow-inner min-h-[850px] flex flex-col font-sans relative text-left">
            <div className="flex justify-between items-start mb-16 border-b-8 border-charcoal pb-12">
              <div>
                <h2 className="text-5xl font-black text-charcoal leading-none">PROFORMA</h2>
                <p className="text-redMain font-black tracking-[0.3em] uppercase text-[10px] mt-2">Commercial Instrument</p>
              </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b-4 border-slate-100">
                    <th className="text-left py-6 text-[9px] font-black uppercase text-gray-400 tracking-[0.2em]">Description</th>
                    <th className="text-center py-6 text-[9px] font-black uppercase text-gray-400 tracking-[0.2em]">Qty</th>
                    <th className="text-right py-6 text-[9px] font-black uppercase text-gray-400 tracking-[0.2em]">Price</th>
                  </tr>
                </thead>
            ...
            <div className="mt-16 pt-12 border-t-8 border-slate-50">
              <div className="flex justify-between items-center bg-charcoal p-8 rounded-[1.5rem] text-white shadow-2xl">
                <div>
                  <p className="text-[8px] font-black uppercase tracking-[0.3em] text-redMain mb-1">Total Due</p>
                  <p className="text-sm font-bold text-white/50 uppercase tracking-widest">Amount Payable</p>
                </div>
         ...
         <div className="space-y-8 text-left">
           ...
           <div>
             <div className="flex justify-between items-center mb-8 border-b pb-4">
               <h3 className="text-sm font-black text-charcoal uppercase tracking-[0.2em]">Service Items</h3>
           ...
           <Button 
               label="Finalize Proforma Invoice" 
               variant="primary"
               icon={<FaSave />}
               onClick={onSave}
               disabled={isSaving}
