...
import { FaArrowLeft, FaGavel, FaFileSignature, FaIdBadge, FaArrowRight } from 'react-icons/fa';
...
const LegalDocs = () => {
  ...
  const documents = [
    { 
      title: 'Affidavit', 
      titleSw: 'Kiapo', 
      description: 'Legally-binding sworn statements of fact for official use.',
      path: '/create/affidavit', 
      icon: FaGavel 
    },
    { 
      title: 'Personal Contract', 
      titleSw: 'Mkataba Binafsi', 
      description: 'Formalize interpersonal agreements with clear, legal terms.',
      path: '/create/personal_contract', 
      icon: FaFileSignature 
    },
    { 
      title: 'Notice Letter', 
      titleSw: 'Barua ya Taarifa', 
      description: 'Official notifications for legal or administrative purposes.',
      path: '/create/notice_letter', 
      icon: FaIdBadge 
    },
  ];
      ...
      <div className="max-w-7xl mx-auto">
        <header className="mb-16">
          ...
          <h1 className="text-4xl md:text-6xl font-black text-charcoal dark:text-white mb-4 uppercase tracking-tighter">
            Legal <span className="text-redMain">& Compliance</span>
          </h1>
          <p className="text-gray-400 font-bold uppercase tracking-widest text-xs">
            Precision-Engineered Legal Documentation
          </p>
        </header>
